...
const firebaseConfig = {
    ...
    storageBucket: "recruitx-cb6f8.appspot.com",
...
// CHANGE THIS IMPORT
var __TURBOPACK__imported__module__$5b$project$5d2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/firebase/client.ts [app-client] (ecmascript)"); // Instead of adminAuth
"use client";
;
// Keep all other imports exactly the same
// ... (keep all other code exactly the same until onSubmit)
async function onSubmit(values) {
    try {
        if (type === 'sign-up') {
            const { name, email, password } = values;
            // CHANGE THIS LINE - use auth instead of adminAuth
            const userCredentials = await createUserWithEmailAndPassword(__TURBOPACK__imported__module__$5b$project$5d2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], email, password);
            ...
            // CHANGE THIS LINE - use auth instead of adminAuth
            const userCredential = await signInWithEmailAndPassword(__TURBOPACK__imported__module__$5b$project$5d2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], email, password);
...
//# sourceMappingURL=_a959df43._.js.map